...
const machine_t machines[] = {
  // clang-format off
    ...
    /* 440EX */
    /* Has a National Semiconductor PC87309 Super I/O chip with on-chip KBC
       with most likely AMIKey-2 KBC firmware. */
    {
        .name = "[i440EX] Dell OptiPlex E1",
        .internal_name = "optiplex_e1",
        .type = MACHINE_TYPE_SLOT1,
        .chipset = MACHINE_CHIPSET_INTEL_440EX,
        .init = machine_at_optiplex_e1_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .bus_flags = MACHINE_PS2_AGP | MACHINE_BUS_USB,
        .flags = MACHINE_IDE_DUAL | MACHINE_SOUND | MACHINE_APM | MACHINE_ACPI | MACHINE_USB, /* Has internal video: ATI Rage IIc AGP, and sound: Crystal CS4236B, and ethernet: 3Com 3C905B-TX */
        .ram = {
            .min = 8192,
            .max = 262144,
            .step = 8192
