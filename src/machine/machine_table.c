...
const machine_t machines[] = {
  // clang-format off
    ...
    /* SiS 5511 */
    /* Has an AMIKEY-2. The BIOS is a fork of AwardBIOS 3.xx with significant modifications */
    {
        .name = "[SiS 5511] AST Bravo LC 51xx",
        .internal_name = "bravo_lc",
        .type = MACHINE_TYPE_SOCKET5,
        .chipset = MACHINE_CHIPSET_SIS_5511,
        .init = machine_at_bravo_lc_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .fdc_device = NULL,
        .sio_device = NULL,
        .vid_device = NULL, /* has SiS 6205 video which is not yet emulated */
        .snd_device = NULL,
        .net_device = NULL
    },
